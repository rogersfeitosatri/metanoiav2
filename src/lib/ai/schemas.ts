...
export const ConversationEngineStateSchema = z.object({
  ...
  experiment_trigger: z.string().max(1000).optional(),
  experiment_action: z.string().max(1000).optional(),
  experiment_objective: z.string().max(1000).optional(),
  experiment_confidence: z.number().min(0).max(10).nullable().optional(),
  experiment_adjustment: z.string().max(1000).optional(),
  ...
  pending_strategy_key: z.string().max(160).optional(),
  pending_strategy_trigger: z.string().max(1000).optional(),
  pending_strategy_action: z.string().max(1000).optional(),
  pending_strategy_objective: z.string().max(1000).optional(),
  pending_strategy_confidence: z.number().min(0).max(10).nullable().optional(),
  pending_alternative_thought_id: z.string().max(200).optional(),
  pending_alternative_thought: z.string().max(1000).optional(),
...
export const ConversationStrategyProposalSchema = z.object({
  ...
  trigger_context: z.string().max(1000).optional(),
  experiment_action: z.string().max(1000).optional(),
  test_objective: z.string().max(1000).optional(),
...
export const ConversationContextSchema = z.object({
  ...
  pending_strategies: z.array(z.object({
    ...
    strategy_key: z.string().max(160).nullable().optional(),
    trigger_context: z.string().max(1000).nullable().optional(),
    experiment_action: z.string().max(1000).nullable().optional(),
    test_objective: z.string().max(1000).nullable().optional(),
    confidence_level: z.number().min(0).max(10).nullable().optional(),
    alternative_thought_id: z.string().max(200).nullable().optional(),
    alternative_thought: z.string().max(1000).nullable().optional(),
  })).max(12).default([]),
...
export const ConversationActionSchema = z.discriminatedUnion("type", [
  ...
  z.object({
    ...
    title: z.string().min(1).max(300),
    trigger_context: z.string().min(1).max(1000),
    experiment_action: z.string().min(1).max(1000),
    test_objective: z.string().min(1).max(1000),
    confidence_level: z.number().min(0).max(10),
    planned_for: z.string().datetime({ offset: true }).nullable().default(null),
    alternative_thought: z.string().max(1000).nullable().default(null),
  }),
  z.object({
